  ...
  return (
    <div className="headerSchool">
      ...
      <div className="headerSchool__slogan">
        ...
        <p>Mejorar la calidad de vida de los niños y familias en situación de vulnerabilidad en el barrio La Cava, otorgando un cambio de rumbo a cada individuo a través de la educación, salud, trabajo, deporte, responsabilidad y compromiso</p>
      </div>
    </div>
  );
}
